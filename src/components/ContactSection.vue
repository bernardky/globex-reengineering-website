<template>
    <section id="contact" class="ud-contact py-20 md:py-32 relative px-12 lg:px-32">
        <div
            ...
            <div class="flex flex-wrap items-center -mx-4">
                <div class="px-4 w-full lg:w-7/12 xl:w-8/12">
                    <div class="ud-contact-content-wrapper">
                        <div class="ud-contact-title mb-12 lg:mb-[150px]">
                            ...
                            <h2 class="text-[35px] font-semibold">Let's get in touch.</h2>
                        </div>
                        <div class="flex flex-wrap justify-between mb-12 lg:mb-0">
                            ...
                            <div class="flex max-w-full w-[330px] mb-8">
                                ...
                                <div>
                                    <h5 class="text-lg font-semibold mb-6">Whatsapp</h5>
                                    <a
                                        href="https://api.whatsapp.com/send?phone=60124775949&text=Hi,%20I%20would%20like%20to%20enquire%20about%20your%20services."
                                        target="blank"
                ...
                <div class="px-4 w-full lg:w-5/12 xl:w-4/12">
                    ...
                    >
                        ...
                        <form>
                            <div class="mb-6">
                                <label for="fullName" class="block text-xs text-dark">Name*</label>
                                <input
                                    type="text"
                                    name="fullName"
